...
def bbox_iou(box1, box2):
    ...
    #Intersection area
    i1 = torch.max(inter_rect_x2 - inter_rect_x1 + 1,torch.zeros(inter_rect_x2.shape).to(get_device()))
    i2 = torch.max(inter_rect_y2 - inter_rect_y1 + 1, torch.zeros(inter_rect_x2.shape).to(get_device()))
    inter_area = i1*i2
