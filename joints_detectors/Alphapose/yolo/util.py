...
def predict_transform(prediction, inp_dim, anchors, num_classes, CUDA = True):
    ...
    x_offset = x_offset.to(get_device())
    y_offset = y_offset.to(get_device())
...
def predict_transform_half(prediction, inp_dim, anchors, num_classes, CUDA = True):
    ...
    x_offset = x_offset.to(get_device()).half()
    y_offset = y_offset.to(get_device()).half()
